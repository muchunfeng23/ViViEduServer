...
public class ViViEduServerSpringBootApplication {
	@Bean
...
//		org.apache.tomcat.jdbc.pool.DataSource dataSource = new org.apache.tomcat.jdbc.pool.DataSource();
		...
		try {
			...
			dataSource.setJdbcUrl("jdbc:mysql://localhost:3306/viviedu_server");
	...
	public static void main(String[] args) {
		SpringApplication.run(ViViEduServerSpringBootApplication.class, args);
	}
}
